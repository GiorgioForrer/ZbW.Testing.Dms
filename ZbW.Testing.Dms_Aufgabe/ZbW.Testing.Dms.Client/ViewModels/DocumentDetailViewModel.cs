    ...
    internal class DocumentDetailViewModel : BindableBase
    {
        ...
        private void OnCmdDurchsuchen()
        {
            ...
            if (result.GetValueOrDefault())
            {
                ...
                Bezeichnung = openFileDialog.SafeFileName;
            }
        }
        ...
        private void OnCmdSpeichern()
        {
            ...
            {
                MessageBox.Show("Es wurde kein Dokument ausgewählt!");
                return;
            }
        ...
        {
            var metadataItem = new MetadataItem(ValutaDatum.Value, SelectedTypItem)
            {
                UserName = Benutzer,
